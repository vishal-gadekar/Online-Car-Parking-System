...
<body class="img js-fullheight"
	...
	<div class="row justify-content-center">
		<h6 class="mb-4">
			<a href="<spring:url value='/customer-login'/>">Go to Home</a>
		</h6>
	</div>
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">Admin/Staff Sign In</h2>
				</div>
			</div>
			<div class="row justify-content-center">
						...
						<div class="row justify-content-center">
							<h6 class="mb-4 text-center">
								Don't Have an account? <a
									href="<spring:url value='/admin-register'/>">Register Here</a>
							</h6>
						</div>
					</div>
				</div>
