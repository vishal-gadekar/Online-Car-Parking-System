		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">Security Staff Details</h2>
				</div>
				<div class="row justify-content-right">
				<div class="col-md-18 text-center mb-5">
					<a href="<spring:url value='/admin-register-staff'/>">Register New Staff</a>
				</div>
			</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					<div class="table-wrap">
						<table class="table table-bordered table-dark table-hover">
							...
							<c:forEach var="c" items="${requestScope.staff_list}">
								<tr>
									<td>${c.firstName}</td>
									<td>${c.lastName}</td>
									<td>${c.email}</td>
